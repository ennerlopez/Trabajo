...
$(document).ready(function () {
   ...
   // var contador = 0;
    var contadorGrupoUno = $("#box1Group #view option").length;
    $("#box2Group #view option").each(function () {



        var valorDos = $(this).val();

        for (var i = 0; i < contadorGrupoUno; i++) {
            var grupoUno = $("#box1Group #view").find("option").eq(i);
           
            var valorUno = $("#box1Group #view").find("option").eq(i).val();

            if (valorDos == valorUno) {
                //alert(valorUno + valorDos);
                $(grupoUno).attr("class", "copiedOption");
            }
        }

        /*
        var valorUno = $("#box1Group #view").find("option").eq(contador).val();
        alert(valorUno + valorDos);
        if (valorDos == valorUno) {
        $(grupoUno).attr("class", "copiedOption");
    ...
    function UpdateLabel(labelGroupID) {
        ...
        $("#" + labelGroupID + " span[class='countLabel']").text('Mostrados ' + $options.size() + ' de ' + $options.add("#" + labelGroupID + " select[name='storage'] option").size());
    }
